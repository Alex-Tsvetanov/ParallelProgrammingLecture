...
\begin{tikzpicture}[scale=0.85]
    % Parallelism
    \node[font=\bfseries] at (0,3.5) {Паралелизъм};
    \draw[fill=green!20, thick] (0,2.5) rectangle (1.5,3) node[pos=.5] {\tiny Task 1};
    \draw[fill=green!20, thick] (0,2) rectangle (1.5,2.5) node[pos=.5] {\tiny Task 2};
    \draw[fill=green!20, thick] (0,1.5) rectangle (1.5,2) node[pos=.5] {\tiny Task 3};
    \node[right] at (2.0,2.25) {\small Едновременно\\изпълнение};
    
    % Concurrency/Async
    \node[font=\bfseries] at (8,3.5) {Асинхронност};
    \draw[fill=blue!20, thick] (6.5,2.8) rectangle (7.4,3.2) node[pos=.5] {\tiny T1};
    \draw[fill=red!20, thick] (7.6,2.8) rectangle (8.3,3.2) node[pos=.5] {\tiny T2};
    \draw[fill=blue!20, thick] (8.5,2.8) rectangle (9.4,3.2) node[pos=.5] {\tiny T1};
    
    \draw[fill=red!20, thick] (6.5,2.2) rectangle (7.2,2.6) node[pos=.5] {\tiny T2};
    \draw[fill=yellow!40, thick] (7.4,2.2) rectangle (8.3,2.6) node[pos=.5] {\tiny T3};
    \draw[fill=blue!20, thick] (8.5,2.2) rectangle (9.4,2.6) node[pos=.5] {\tiny T1};
    
    \node[right] at (9.7,2.5) {\small Чередуване};
\end{tikzpicture}
\end{center}
