...
\begin{tikzpicture}[scale=0.75]
    ...
    \draw[-Latex, thick] (broker.east) -- ++(1,0) |- (broker.east) -- ++(1.5,1.0) node[right] {\tiny Sub1};
    \draw[-Latex, thick] (broker.east) -- ++(1,0) |- (broker.east) -- ++(1.5,0.0) node[right] {\tiny Sub2};
    \draw[-Latex, thick] (broker.east) -- ++(1,0) |- (broker.east) -- ++(1.5,-1.0) node[right] {\tiny Sub3};
    ...
    \draw[-Latex, thick, green!60!black] (broker2.east) -- ++(1.5,0) |- (broker2.east) -- ++(2.0,1.0) node[right] {\tiny Sub1};
    \draw[-Latex, thick, green!60!black] (broker2.east) -- ++(1.5,0) |- (broker2.east) -- ++(2.0,0.0) node[right] {\tiny Sub2};
    \draw[-Latex, thick, green!60!black] (broker2.east) -- ++(1.5,0) |- (broker2.east) -- ++(2.0,-1.0) node[right] {\tiny Sub3};
